...
import OfflineScreen from "./index";
...
test('renders correctly', () => {
  const tree = renderer.create(<Provider store={store}><OfflineScreen /></Provider>).toJSON();
...
it('should be handling OfflineScreen', () => {
  let store = mockStore({
    ...
    NotificationState: {
      ...
      NotificationSettingsState: { pushNotification: [], emailNotification: [] }
    }
  });
  let context = { store };
  let wrapper = shallow(
