...
const styles = StyleSheet.create({
    ...
    navBarContainer: {
        flexDirection: 'row',
        marginTop: setValueBasedOnHeight(34),
    ...
    skillItemsList: {padding: setValueBasedOnWidth(3)},
...
color: THEME_PRIMARY_COLOR,
    ...
    addressTypeStyle: { flexDirection: 'row', flex: 1, alignItems: 'center'},
    
    validAdderss: {
        color: '#c04e59',
        marginLeft: setValueBasedOnWidth(41), 
        fontWeight: '600',
        fontSize: setFontSize(14),
        marginTop: setValueBasedOnHeight(17)
    }
})
