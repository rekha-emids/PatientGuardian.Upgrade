export let profileState = {
    ...
    CoreoAssociationState: { CoreoAssociationData: {}, isLoading: 0 },
    LanguagesState: {
        ...
        isLoading: 0,
        selectedLanguagesList: [{ id: 7, name: "Chuukese" }],
        serviceProviderId: -1,
        updatedLanguagesList: { 7: { id: 7, name: "Chuukese" } }
    },
    PersonalDetailState: {
...
export let item = {
    ...
    onPress: jest.fn(),
    onUpdateIsEdited: jest.fn(),
    selectedItemStyle: 1441
}

export let nextProps = {
    ...
    languageState: {
        ...
        updatedLanguagesList: {
            3: { id: 3, name: "Filipino" },
            7: { id: 7, name: "Chuukese" }
        }
    },
    navigation: navigation[0],
    resetUpdatedLanguages: jest.fn(),
