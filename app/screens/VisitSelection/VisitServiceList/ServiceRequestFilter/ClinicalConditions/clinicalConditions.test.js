...
import ClinicalConditions from "./index";
...
describe('ClinicalConditions component', () => {
    it('ClinicalConditions', () => {  
      ...
      const context = { store };
        wrapper = shallow(
          <ClinicalConditions types={[{serviceTypeId: 1, serviceTypeDescription: "hey"}]} {...props} onClickNext= {() => {}} data={[]} startOrStopService={() => {}} performTasksList={{visitStatus: 'IN_PROGRESS', visitStartTime: null, visitEndTime: null, visitTimeDuration: null}}/>,
          { context },
        ),
        inst = wrapper.dive().instance()
        inst.renderClinicalConditions()
      })
})