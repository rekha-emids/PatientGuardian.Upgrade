...
import AttributeProviders from "./index";
...
describe('ServiceRequestCard component', () => {
    it('ServiceRequestCard', () => {  
      ...
      const context = { store };
        wrapper = shallow(
          <AttributeProviders types={[{serviceTypeId: 1, serviceTypeDescription: "hey"}]} {...props} onClickNext= {() => {}} data={[]} startOrStopService={() => {}} performTasksList={{visitStatus: 'IN_PROGRESS', visitStartTime: null, visitEndTime: null, visitTimeDuration: null}}/>,
          { context },
        ),
