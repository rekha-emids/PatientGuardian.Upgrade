...
export default StyleSheet.create({
    ...
    listView: {
        ...
        marginBottom: setValueBasedOnHeight(62)
    },
    listItem: {
        backgroundColor: '#ffffff',
        alignItems: 'center',
        ...
        borderBottomColor: '#e1e1e1',
        padding: setValueBasedOnWidth(15)
    },
    ...
    overlayStyle: {flex: 1},
    listValueItem: { flex: 2, marginHorizontal: setValueBasedOnWidth(5), flexDirection: "row", justifyContent: "flex-end", alignItems: "center" },
    row: {
        flexDirection: "row",
        alignItems: "center"
    },
    rightMargin: {marginHorizontal: setValueBasedOnWidth(5)},
    textRight: {textAlign: "right"},
    margin: {marginLeft: setValueBasedOnWidth(5)}
})