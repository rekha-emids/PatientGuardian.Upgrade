...
jest.mock('react-navigation-redux-helpers', () => ({reactNavigationReduxHelpers: 'mockReactNavigationReduxHelpers'}))
  ...
  it('should be handling DashboardDetails', () => {
    ...
    let onApplyFilterData = {
        ...
        minAge: 10,
        maxAge: 30,
        selectedGenderId: 222,
        selectedContractId: 123
    }
    ...
    inst.onSearch();
    inst.onResetFilter();
    inst.componentWillReceiveProps({fromDate: '01/01/2019', toDate: '31/01/2019'})
    inst.onSortChange(true);
    inst.onApplyFilter(onApplyFilterData);
    inst.onInactivity(jest.fn())
  })